            ...
            <tr>
              <td>
                <p class="cdtitle">
                  ...
                  <br class="sp">ザ・タートルズ 〜結成30周年記念 第一弾〜 （イベント）
                </p>
                <div class="txtBloc">
                  <p class="ttl"><a href="https://topbeatclub.com" target="_blank" class="bold">2024/03/09(土)　Top  Beat Club (東京都)</a></p>
                  <p class="ttl bold" style="margin-top: 0.5rem">〜1st Anniversary of Top Beat Club〜Pop Trip</p>
                  <p class="txt">
                    ■出演：ザ・カスタネッツ／ザ・タートルズ<br>
                    ■開場18:15／開演19:00 <br>
                    ■料金 adv ¥4,000 / day ¥4,500 (+1ドリンク)<br>
                    ■チケット：2024.01.13 18:00〜 <a href="https://peatix.com/event/3805178" target="_blank" >Peatix</a>にて発売<br>
										■入場順：Peatix → 各バンドメール予約
										<br>
                  </p>
                </div>
              </td>
              ...
              <td>
                <p class="cdtitle">
                  <span style="background-color:#70b539">LIVE</span>
                  <br class="sp">ザ・タートルズ 〜結成30周年記念 第二弾〜 （ワンマン） 
                </p>
                <div class="txtBloc">
                  <p class="ttl"><a href="http://club251.com/" target="_blank" class="bold">2023/04/07（日）下北沢CLUB251 (東京都)</a></p>
                  <p class="ttl bold" style="margin-top: 0.5rem">『ザ・タートルズ 30th Anniversary LIVE』<br>〜応答せよ！こちらタートル号〜</p>
                  <p class="txt">
                    ■出演：ザ・タートルズ<br>
                    ■開場：16:30／開演17:00 <br>
