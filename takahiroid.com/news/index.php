          ...
          <table border="0" class="news_table">
              ...
              <td>
                ...
                <div class="txtBloc">
                  ...
                  <p class="txt">
                    ■時間:<br> 開場16:00 / 開演17:00<br>
										■チケット: <br>全席指定 8,800円 (税込・入場時別途ドリンク代必要) <br>
                    ■チケット一般発売日: <br>2024年9月7日（土曜日）10:00より各プレイガイドにて<br>
										■お問い合わせ: <br>キョードーインフォメイション【電話】<a href="tel:0570-200-888" class="blue">0570-200-888</a>（月-土11:00～16:00）
                  </p>
                </div>
              </td>
            </tr>
              ...
              <td>
                ...
                <div class="txtBloc">
                  ...
                  <p class="txt">
                    ...
                    ■チケット一般発売日: <br>2024年9月7日（土曜日）10:00より各プレイガイドにて
										■お問い合わせ: <br>ディスクガレージ <a href="https://info.diskgarage.com/" target="_blank">https://info.diskgarage.com/</a>
                  </p>
                </div>
              </td>
            </tr>
              ...
              <td>
                ...
                <div class="txtBloc">
                  ...
                  <p class="txt">
                    ...
                    ■open12:00/start12:30<br>
										■料金: ￥4000+D/￥4500+D<br>
                    ■チケット: 発売中（ローソン・イープラス）<br>
                  </p>
                </div>
              </td>
            </tr>
              ...
              <td>
                ...
                <div class="txtBloc">
                  <p class="ttl"><a href="https://sactone.com/index/" target="_blank" class="bold">2024/06/15（土）新宿Sact!</a></p>
                  <p class="ttl bold" style="margin-top: 0.5rem">松酒屋 創立三百十年記念式典 </p>
                  <p class="txt">
                    ■出演: 酒井ミキオ(社長)、松本タカヒロ(副社長)、ha-j(専務)<br>

										<br>
										<p class="text-red">
											メンバー体調不良により中止となりました。<br>
											チケット予約済みの方にはSACT!よりメールにてご連絡させて頂いております。<br>
											<br><br>
										</p>

										■お問い合わせ: <a href="mailto:nfosow@sactco.jp">infosow@sactco.jp</a>
                  </p>
                </div>
              </td>
            </tr> -->
